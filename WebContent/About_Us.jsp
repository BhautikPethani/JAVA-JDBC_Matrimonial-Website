...
<header>
	...
	<%@page import="java.sql.*"%>
		<%
			...
			PreparedStatement pst1 = conn1.prepareStatement("select count(sid) from signup");
			...
			PreparedStatement pst2 = conn2.prepareStatement("select count(pid) from profile");
		...
		<h3>Love Units them..</h3>
		<p>Registered People  : <%= sid %></p>
		<p>Registered Profile : <%= pid %></p>
		<br><br><br><br>
