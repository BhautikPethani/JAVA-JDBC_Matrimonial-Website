...
<%
	...
	if(name!=null && dob!=null)
	{
		...
		{		
			...
			PreparedStatement pst = conn.prepareStatement("insert into profile (name,dob,gender,mobile_no,address,email,languages_known,skills,hobbies,habit,about_self,expectation,height,education,occupation,nature,father_name,mother_name,sibling,sid) values (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)");
                 ...
                 <form>
                    ...
                    <table>
                        <tr>
                            ...
                            <td><p>Habit :  </p></td>
                            <td><input type="text" name="habit" placeholder="Habit" required/></td>
                        </tr>
                        <tr>
                                <td><p>Date Of Birth : </p></td>
                                <td><input type="date" name="BirthDate" required/></td>
                                <td><p>About Self : </p></td>
                                <td><input type="text" name="aboutself" placeholder="About Self" required/></td>
                        </tr>
                        <tr>
                                <td><p>Gender : </p></td>
                                ...
                                <td><input type="text" name="expect" placeholder="Expectation" required/></td>
                        </tr>
                        <tr>
                                <td><p>Mobile No : </p></td>
                                <td><input type="text" name="mob" placeholder="Mobile No" required/></td>
                                <td><p>Occupation : </p></td>
                                <td><input type="text" name="occu" placeholder="Occupation" required/></td>
                        </tr>
                        <tr>
                                <td><p>Address : </p></td>
                        ...
                        <tr>
                                ...
                                <td><input type="text" name="email" placeholder="@xyz.com" required/></td>
                                <td><p>Education : </p></td>
                                <td><input type="text" name="edu" placeholder="Education" required/></td>
                        </tr>
                        
                        <tr>
                                <td><p>Skills :  </p></td>
                                <td><input type="text" name="skill" placeholder="Skills" required/></td>
                                <td><p>Nature : </p></td>
                                <td><input type="text" name="nature" placeholder="Nature" required/></td>
                        </tr>
                        <tr>
                                <td><p>Hobbies :  </p></td>
                                <td><input type="text" name="hobby" placeholder="Hobbies" required/></td>
                        ...
                        <tr>
                                ...
                                <td><p>Sibling : </p></td>
                                <td><input type="text" name="sibling" placeholder="Sibling" required/></td>
                        </tr>
                        <tr>
